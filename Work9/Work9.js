...
let cloneNewDiv = newDiv.cloneNode(true)
document.body.appendChild(cloneNewDiv)
...
for (let i = 0; i < coursesAndDurationArray.length; i++) {
    ...
    div.innerText = `Title: ${coursesAndDurationArray[i].title}, Month Duration: ${coursesAndDurationArray[i].monthDuration}`
...
for (let i = 0; i < coursesAndDurationArray1.length; i++) {
    ...
    h1.innerText = `Title: ${coursesAndDurationArray1[i].title}`;
    p.innerText = `Month Duration: ${coursesAndDurationArray1[i].monthDuration}`;
    div.appendChild(h1);
    div.appendChild(p);
    newDiv3.appendChild(div);
}
...
for (let i = 0; i < simpsons.length; i++) {
    ...
    p2.innerText = `Info: ${simpsons[i].info}`;
